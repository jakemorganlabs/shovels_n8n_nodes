...
### Changed
- README: author links (portfolio, LinkedIn, contact) replace the operator
  placeholders.
- README: verification status points at the per-version provenance ledger
  instead of hard-coding the latest logIndex.
