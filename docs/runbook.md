...
> Controlled document for operators. Covers build, publish, rollback, and closeout.
...
Validation-cut hard cap: **three cuts maximum** (v0.1.0 → v0.1.2). If not clean by then, pause and diagnose structurally before burning v1.0.0.
